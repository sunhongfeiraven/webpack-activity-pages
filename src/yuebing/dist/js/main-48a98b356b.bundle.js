(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('../../../build/env.dev.js')) :
	typeof define === 'function' && define.amd ? define(['../../../build/env.dev.js'], factory) :
	(factory(global.env));
}(this, (function (env) { 'use strict';

env = env && env.hasOwnProperty('default') ? env['default'] : env;
